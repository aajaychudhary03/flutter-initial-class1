...
void runService(){
  ...
  List dynamicData = ["test", 1, {},];

  List<Map<String, int>> studentWithScore = [{"safal": 78}, {"sujan": 70}];
  ...
  flutterStudentMap.update('Name', (value) => value=='Test'?'newValue':value,ifAbsent: ()=>'widget');
